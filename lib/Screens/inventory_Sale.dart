...
import 'package:mobilysystem/Widgets/Inventory_Sale_Widget.dart';
                  ...
                  child:  Column(
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("فاتوره بيع" , style: TextStyle(color: Colors.white , fontSize: 22),),
                      ...
                      Row(
                        ...
                        Row(
                          children: [
                            Text("تقسيط" , style: TextStyle(color: Colors.white),),
